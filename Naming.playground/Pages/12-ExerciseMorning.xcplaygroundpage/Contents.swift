...
let totalTimeOfActivities = brushTeeth + cleanRoom + washFace + chooseClothes + shower + makeBreakfast + eat
...
// Things I have to do
let timeOfThingsIHaveToDo = brushTeeth + washFace + chooseClothes + shower
// Things I Like to do
let thingsILikeToDo = cleanRoom + makeBreakfast + eat
...
*/
// I would spend less time cleaning room cause I usally take 15 minutes to fully clean my room
